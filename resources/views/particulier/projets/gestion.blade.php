...
@section('title')
    <title>Gestion Projet - Gardena Connect</title>
@endsection

@section('particulierContent')
    <div class="p-6 bg-white rounded-xl shadow-sm min-h-full">
        <div class="overflow-x-auto rounded-lg border border-gray-200">
            <table class="min-w-full text-left">
                ...
                <tbody class="divide-y divide-gray-200 text-sm">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-4 text-center text-gray-500 text-lg">Aucun projet en cours</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
